...
public class tester2 {
    ...
    public static void main(String args[]) {
		...
		MyPQSortedList<Integer, String> pr1 = new MyPQSortedList<Integer, String>();
		...
		long startTime = System.nanoTime();
			...
			System.out.println("Execution Time for inserting(K,V) method for MyPQSortedList  "+(stopTime-startTime)+" nanoseconds");
			if((pr1.min()) != null)
			...
			System.out.println("Execution Time for removeMin method for MyPQSortedList  "+(stopTime2-starTime2)+" nanoseconds");
		}
