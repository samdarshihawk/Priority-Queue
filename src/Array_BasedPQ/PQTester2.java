...
public class PQTester2 {
    
    public static void main(String args[]) {
		
		MyPQSortedArray pr1 = new MyPQSortedArray();
		...
		Random rand = new Random();
			...
			System.out.println("Execution Time for inserting(K,V) method for MyPQSortedArray  "+(stopTime-startTime)+" nanoseconds");
			if((pr1.min()) != null)
			...
			System.out.println("Execution Time for removeMin method for MyPQSortedArray  "+(stopTime2-starTime2)+" nanoseconds");
